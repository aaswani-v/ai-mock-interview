                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 perspective-1000">
                        ...
                        <TiltCard className="h-[450px] flip-card-container group cursor-pointer border-none bg-transparent shadow-none hover:shadow-none">
                            <div className="flip-card-inner">
                                ...
                                {/* BACK */}
                                <div className="flip-card-back bg-slate-900 border border-purple-500/30 flex flex-col items-center justify-center p-8 text-center bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]">
                        ...
                        <TiltCard className="h-[450px] flip-card-container group cursor-pointer border-none bg-transparent shadow-none hover:shadow-none">
                            <div className="flip-card-inner">
                                ...
                                {/* BACK */}
                                <div className="flip-card-back bg-slate-900 border border-green-500/30 flex flex-col items-center justify-center p-8 text-center bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]">
