        ...
        <div className="h-full p-6 max-w-7xl mx-auto animate-fade-in-up overflow-y-auto custom-scrollbar">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
                ...
                <div className="flex gap-2 sm:gap-3 w-full sm:w-auto">
                    <Button onClick={() => window.location.reload()} variant="secondary" icon={RefreshCw} className="flex-1 sm:flex-none text-sm">Re-analyze</Button>
                    <Button onClick={onContinue} icon={ArrowRight} className="flex-1 sm:flex-none text-sm">Continue</Button>
                </div>
            </div>
